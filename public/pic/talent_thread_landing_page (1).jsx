    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-900 via-slate-900 to-black text-slate-100 antialiased">
      ...
      <header className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-slate-300" aria-label="Primary">
          <a href="#why" className="hover:underline focus:outline-none">Why join</a>
          <a href="#community" className="hover:underline focus:outline-none">Community</a>
          <a href="#waitlist" className="px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-500 shadow-lg">Pre-register</a>
        </nav>
      ...
      <main>
        <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight">Shaping the future of design careers</h1>
            <p className="text-slate-300 max-w-2xl text-lg">Talent Thread is an AI-powered growth ecosystem for designers — portfolio analysis, skill roadmaps, curated freelance projects, and a thriving community. Join as a founding member.</p>

            <div className="flex flex-wrap gap-4 items-center">
              <a href="#waitlist" className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-purple-500 to-indigo-500 shadow-xl font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-400">Pre-register as Designer</a>

              <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-slate-800/60 border border-slate-700 text-slate-100/90">Join Our Community</a>
            </div>
            ...
            <div className="mt-8 text-sm text-slate-400">Founding members receive priority onboarding, special community badges, and access to early projects.</div>
          </div>
          ...
          <div className="lg:col-span-6 flex items-center justify-center">
            ...
            <figure className="w-full max-w-lg rounded-3xl bg-gradient-to-tr from-indigo-900/40 to-slate-900/30 p-6 border border-slate-800 shadow-2xl">
              <MockIllustration />
              <figcaption className="mt-4 text-slate-400 text-sm">AI-powered portfolio analysis — visual-only mockup (replace with final art)</figcaption>
            </figure>
          </div>
        </section>
        ...
        <section id="why" className="max-w-7xl mx-auto px-6 py-12 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-7">
            ...
            <p className="text-slate-400 mt-3 max-w-xl">We combine human curation and AI to help designers showcase better, learn faster, and connect with higher-quality clients.</p>

            <dl className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <StatCard title="Objective Reviews" desc="AI + human-curated checks against UX, visual design, and market fit." />
          ...
          <aside className="lg:col-span-5">
            <div className="rounded-2xl p-6 bg-gradient-to-br from-slate-800/40 to-slate-900/40 border border-slate-800 shadow-inner">
              ...
              <div className="mt-6 h-36 bg-gradient-to-tr from-indigo-900/20 to-slate-800/20 rounded-lg flex items-center justify-center text-slate-400">Activity sparkline / chart (replace with real data)</div>

              <div className="mt-6 flex gap-3">
                <a href="#community" className="flex-1 inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-500 font-semibold">Join Discord</a>
                <a href="#waitlist" className="inline-flex items-center justify-center px-4 py-2 rounded-lg border border-slate-700">Pre-register</a>
              </div>
            </div>

            <div className="mt-6 text-slate-400 text-sm">Community-first: live critiques, office hours, project channels, and design challenges.</div>
          </aside>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <FeatureDeep
              ...
              bullets={["3-tier skill plans with checkpoints", "Portfolio tasks after each sprint", "Mentor review windows for top performers"]}
            />

            <FeatureDeep
              title="Curated Projects"
              bullets={["Verified clients and fair payment policies", "Project briefs matched to your skill level", "Support for scope & contracts"]}
            />
          </div>
        </section>
        ...
        <section id="community" className="max-w-7xl mx-auto px-6 py-12">
          <div className="rounded-3xl p-8 bg-gradient-to-br from-indigo-900/30 to-slate-900/30 border border-slate-800 flex flex-col md:flex-row items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-slate-400 mt-2">Join live critiques, portfolio jams, AMAs with agencies, and collaborations happening in Discord.</p>
            </div>

            <div className="flex gap-4">
              <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-2xl bg-gradient-to-r from-purple-500 to-indigo-500 font-semibold shadow-lg">Join the Community</a>
              <a href="#waitlist" className="px-6 py-3 rounded-2xl border border-slate-700">Pre-register</a>
            </div>
          </div>
        </section>
        ...
        <section id="waitlist" className="max-w-3xl mx-auto px-6 py-12">
          <div className="rounded-2xl p-8 bg-gradient-to-br from-slate-900 to-slate-800/60 border border-slate-800 shadow-2xl">
            ...
            <p className="text-slate-400 mt-2">Short form — we only ask what matters. We'll email when onboarding opens.</p>

            <form onSubmit={submitWaitlist} className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4" aria-label="Waitlist form">
              ...
              <div className="sm:col-span-2 flex items-center gap-4">
                ...
                {status === "success" && <div className="text-green-400">Thanks — we’ll email you when onboarding opens.</div>}
                {status === "error" && <div className="text-rose-400">Something went wrong. Please try again later.</div>}
              </div>
            </form>

            <p className="mt-4 text-xs text-slate-500">We respect your privacy. Data is used only for product updates and onboarding invites.</p>
          </div>
        </section>
      </main>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-10 text-slate-500 text-sm">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="mailto:hello@talentthread.design" className="hover:underline">Contact</a>
          </div>
        </div>
      </footer>
    </div>
...
function MobileCTAs() {
  return (
    <div className="flex items-center gap-3">
      <a href="#waitlist" className="px-3 py-2 rounded-lg bg-indigo-600 text-sm">Pre-register</a>
    </div>
  );
}
